  ...
  return (
    <div className="flex items-center">
      <svg width="128" height="32" viewBox="0 0 128 32" role="img" aria-label="FireAnt logo">
        <defs>
          <radialGradient id="fireant-radial-gradient" cx="36.22" cy="5.33" r="39.36" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#05e6fd" />
            <stop offset="1" stopColor="#157cff" />
          </radialGradient>
          <linearGradient id="fireant-linear-gradient" x1="10.43" y1="16.55" x2="13.14" y2="24.88" gradientUnits="userSpaceOnUse">
          ...
          <linearGradient id="fireant-linear-gradient-2" x1="15.93" y1="25.47" x2="16.27" y2="8.37" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#fff" stopOpacity="0" />
            <stop offset="1" stopColor="#fff" />
          </linearGradient>
        </defs>
        <g transform="translate(0 0)">
          <svg x="0" y="0" width="32" height="32" viewBox="0 0 32 32">
            <rect fill="url(#fireant-radial-gradient)" width="32" height="32" rx="5.63" />
            <path fill="url(#fireant-linear-gradient)" d="M9,26.16h.92A4.56,4.56,0,0,0,14.4,22L15,15.33h0s-1.19-.9-3.57,2.71-3,4.93-3,5.72c0,.49-.05,1.3-.07,1.84A.54.54,0,0,0,9,26.16Z" />
            <path fill="url(#fireant-linear-gradient-2)" d="M17.4,10.83l.92-.16h0c-.39-.35-.8-.69-1.22-1A.35.35,0,0,1,17,9.29a.34.34,0,0,1,.32-.23h.07a18.59,18.59,0,0,1,2.7.81c.32.13.65.26,1,.41a.94.94,0,0,0,.37.07h.07A.87.87,0,0,0,22,9.87h0v0l1.61-3.7h0c-.5-.07-1-.13-1.51-.18-.27,0-.54,0-.82-.06h0c-.64,0-1.28-.07-1.93-.07a29.37,29.37,0,0,0-7.13.87l-.15,0h0A4.21,4.21,0,0,0,9,10.53H9v.27H9l-.11,3.07h0c.32-.18.64-.34,1-.5A29.1,29.1,0,0,1,17.4,10.83Z" />
          ...
          <svg x="32" y="0" width="96" height="32" viewBox="0 0 96 32" className="hidden md:block">
